...
## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/abdu_gafor_) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/abdugafor-gafarov) 
...
UAE. Developed the entire application from scratch using Angular and its
reactive forms. Fully integrated with the backend API for authorization, data
synchronization and application management. Added a personal account,
authorization, blog, application status tracking. Implemented adaptive design
for all devices using T ailwind CSS. Added multilingualism using ngx-translate
...
processes: online cash register, warehouse, finance, analytics and CRM.
Developed the client part of the application using React. Worked with forms.
Used the Ant-design library to simplify and quickly develop a modern
